...
/**
 * <b>RatNum</b> represents an <b>immutable</b> rational number. It includes all
 * of the elements in the set of rationals, as well as the special "NaN"
...
public final class RatNum extends Number implements Comparable<RatNum> {
	 ...
	 * 
	 * @return a double approximation for this. Note that "NaN" is mapped to
	 *         {@link Double#NaN}, and the {@link Double#NaN} value is treated
	 *         in a special manner by several arithmetic operations, such as the
	 *         comparison and equality operators. See the <a href=
	...
	/**
	 * Returns an integer approximation for this. The rational number is rounded
	...
	/**
	 * Returns a float approximation for this. This method is specified by our
	 * superclass, Number.
	 */
	@Override
	...
	/**
	 * Returns a long approximation for this. This method is specified by our
	 * superclass, Number. The value returned is rounded to the nearest long.
	 */
	@Override
	 ...
	 * @requires arg != null
	 * @return a RatNum equal to (this + arg). If either argument is NaN, then
	 *         returns NaN.
	 */
	 ...
	 *            The divisor.
	 * @requires arg != null
	 * @return a RatNum equal to (this / arg). If arg is zero, or if either
	 ...
	 * 
	 * @param a,
	 *            b The numbers for which to find the GCD.
	 * @requires b != 0
	 ...
	 *         and 'obj' represent the same rational number. Note that NaN = NaN
	 *         for RatNums.
	 */
	@Override
	 ...
	 *         will either be "NaN", or it will take on either of the forms "N"
	 *         or "N/M", where N and M are both integers in decimal notation and
	 *         M != 0.
	 */
	@Override
	 ...
	 *           <UL>
	 *           <LI>"NaN"
	 *           <LI>"N/M", where N and M are both integers in decimal notation,
	 *           and M != 0, or
	 *           <LI>"N", where N is an integer in decimal notation.
	 *           </UL>
	 * @returns NaN if ratStr = "NaN". Else returns a RatNum r = ( N / M ),
	 *          letting M be 1 in the case where only "N" is passed in.
	 */
